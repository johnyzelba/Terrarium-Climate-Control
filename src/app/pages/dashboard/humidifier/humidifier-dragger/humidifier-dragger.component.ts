...
import { Humidifier } from '../../../../@core/data/humidifier';


const VIEW_BOX_SIZE = 300;

@Component({
  selector: 'ngx-humidifier-dragger',
  templateUrl: './humidifier-dragger.component.html',
  styleUrls: ['./humidifier-dragger.component.scss'],
})
export class HumidifierDraggerComponent implements AfterViewInit, OnChanges, OnInit {
  ...
  SendDataToServer() {
    ...
    //this.wsServise.sendTempData(this.temperatureOff.toString());
  }

  ngOnInit() {
    this.off=this.humidityOff;
  }
  ...
  switchPower() {
    ...
    this.calculateGradientConePaths(0.5);
    this.off = !this.off;
  ...
  private invalidate(): void {
    this.bottomAngleRad = HumidifierDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
